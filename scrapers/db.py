...
virt_l2 = Table(
    ...
    Column("CancelPolicy", String(512), nullable=True),
    Column("CancellationInstructionsDisplay", String(512), nullable=True),
    Column("CommissionDetails", String(512), nullable=True),
    Column("CurrencySymbol", String(21), nullable=True),
    Column("DepositDisplay", String(512), nullable=True),
    Column("Description", String(512), nullable=True),
    Column("GuarantPolicy", String(512), nullable=True),
    Column("GuaranteeDisplay", String(512), nullable=True),
    Column("GuaranteeType", String(512), nullable=True),
    Column("IataCharacteristicIdentification", String(512), nullable=True),
    Column("IataCharacteristicIdentificationApiEquivalent",
    ...
    Column("PricingDisclaimer", String(512), nullable=True),
    Column("PromotionName", String(512), nullable=True),
    Column("RateAccessCode", String(512), nullable=True),
    Column("RateAccessCodeApiEquivalent", String(512), nullable=True),
    ...
    Column("SabreBookingKey", String(512), nullable=True),
